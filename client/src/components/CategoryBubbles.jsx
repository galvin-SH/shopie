    ...
    <div className="bubble-container">
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Candy} alt="Candy" className="w-20" />
        </div>
      </a>
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Chips} alt="Chips" className="w-20" />
        </div>
      </a>
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Chocolate} alt="Chocolate" className="w-20" />
        </div>
      </a>
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Crackers} alt="Crackers" className="w-20" />
        </div>
      </a>
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Drinks} alt="Drinks" className="w-20" />
        </div>
      </a>
      <a href="#" target="_blank">
        <div className="bubble">
          <img src={Savory} alt="Savory" className="w-20" />
        </div>
      </a>
    </div>
  );
