            ...
            {state.products.length != 0 ? (
                <div className="border-1 rounded-xl shadow-gray-400 shadow-xl flex-col w-60 group cursor-pointer relative">
                    ...
                    <ul className="flex justify-between m-2 p-2">
                        ...
                        {Auth.loggedIn() ? (
                            <>
                                <button type="button" onClick={addToCart} className="text-white #D1D5DB hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
